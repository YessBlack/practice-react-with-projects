export function Player ({ numberPlayer, move, classNameBorder }) {
  const classNameBG = numberPlayer === 1 ? 'text-player-one' : 'text-player-two'

  return (
    <article className={`p-1 w-[100px] h-[130px] border-2 border-b-8 rounded-xl bg-white text-center ${classNameBorder}`}>
